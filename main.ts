namespace SpriteKind {
    export const heroshoot = SpriteKind.create()
    export const 敵人5 = SpriteKind.create()
    export const enemy_3 = SpriteKind.create()
    export const enemy_2 = SpriteKind.create()
    export const enemy_1 = SpriteKind.create()
    export const 敵人6 = SpriteKind.create()
    export const 敵人7 = SpriteKind.create()
    export const 寵物 = SpriteKind.create()
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (方向變數 == 1) {
        ...
        hero_左_飛彈 = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
    ...
    if (方向變數 == 2) {
        ...
        hero_右_飛彈 = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
    ...
    if (方向變數 == 3) {
        ...
        hero_上_飛彈 = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
    ...
    if (方向變數 == 4) {
        ...
        hero_下_飛彈 = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.敵人5, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.敵人6, function (sprite, otherSprite) {
...
function 從敵人射出的飛彈_敵人6 () {
    敵人6 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.敵人6)
    敵人6.setPosition(敵人3.x + randint(-10, 10), 敵人3.y + randint(-10, 10))
    敵人6.setVelocity(randint(-50, 50), randint(-50, 50))
    敵人6.setBounceOnWall(true)
}
function herostartpoint () {
    for (let value of tiles.getTilesByType(assets.tile`我的貼圖2`)) {
        tiles.placeOnRandomTile(hero, assets.tile`我的貼圖2`)
        tiles.setTileAt(value, assets.tile`我的貼圖`)
    }
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.敵人5, function (sprite, otherSprite) {
    sprites.destroy(otherSprite, effects.warmRadial, 100)
    scene.cameraShake(4, 100)
    otherSprite.setFlag(SpriteFlag.Ghost, true)
    info.changeLifeBy(-1)
...
function 關卡敵人初始化 () {
    ...
    tiles.placeOnTile(敵人1, tiles.getTileLocation(31, 5))
    敵人2 = sprites.create(img`
        . . f f f . . . . . . . . f f f 
        . f f c c . . . . . . f c b b c 
        f f c c . . . . . . f c b b c . 
        f c f c . . . . . . f b c c c . 
    ...
    tiles.placeOnTile(敵人2, tiles.getTileLocation(12, 9))
    敵人3 = sprites.create(img`
        . . . . c c c c c c . . . . . . 
        . . . c 6 7 7 7 7 6 c . . . . . 
        . . c 7 7 7 7 7 7 7 7 c . . . . 
    ...
    tiles.placeOnTile(敵人3, tiles.getTileLocation(54, 2))
}
function 從敵人射出的飛彈_敵人5 () {
    敵人5 = sprites.create(assets.image`我的影像5`, SpriteKind.敵人5)
    敵人5.setPosition(敵人2.x + randint(-10, 10), 敵人2.y + randint(-10, 10))
    敵人5.setVelocity(randint(-50, 50), randint(-50, 50))
    敵人5.setBounceOnWall(true)
}
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    阿奇 = sprites.create(img`
        ...
        ee....4444....4444.....ee
        ee...54555e..e5554.....ee
        ee...455555ee555554....ee
        ee...45544555544554....ee
        ee...e544555555445e....ee
        ee....ee55555555ee.....ee
        ee....fe5f5555f5e44....ee
        ee.....f55544555fff....ee
        ee.....f455ff556fff....ee
    ...
    阿奇.setPosition(hero.x + 0, hero.y + 0)
    阿奇.follow(hero, 100)
    阿奇.startEffect(effects.fire, 500)
    pause(2000)
    sprites.destroy(阿奇, effects.coolRadial, 500)
    music.play(music.createSoundEffect(WaveShape.Noise, 1600, 55, 255, 65, 300, SoundExpressionEffect.None, InterpolationCurve.Curve), music.PlaybackMode.UntilDone)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.敵人7, function (sprite, otherSprite) {
    sprites.destroy(otherSprite, effects.confetti, 100)
    scene.cameraShake(4, 100)
    otherSprite.setFlag(SpriteFlag.Ghost, true)
})
...
function 從敵人射出的飛彈_敵人7 () {
    敵人7 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . 3 3 . . . . . . . 
        . . . . . . 3 1 1 3 . . . . . . 
        . . . . . . 3 1 1 3 . . . . . . 
        . . 3 2 2 3 1 1 3 1 3 2 2 . . . 
        . . 3 3 1 1 1 1 3 1 1 1 3 3 . . 
        . . 3 3 1 3 3 3 3 1 1 1 3 3 . . 
        . . . 3 1 1 1 3 3 3 3 1 3 . . . 
        . . . . 3 1 1 3 1 1 1 3 . . . . 
        . . . . 2 1 1 1 1 1 1 2 . . . . 
        . . . . 2 1 1 3 3 1 1 2 . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.敵人7)
    敵人7.setPosition(敵人1.x + randint(-10, 10), 敵人1.y + randint(-10, 10))
    敵人7.setVelocity(randint(-50, 50), randint(-50, 50))
    敵人7.setBounceOnWall(true)
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.敵人7, function (sprite, otherSprite) {
    sprites.destroy(otherSprite, effects.warmRadial, 100)
    scene.cameraShake(4, 100)
    otherSprite.setFlag(SpriteFlag.Ghost, true)
    info.changeLifeBy(-1)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.敵人6, function (sprite, otherSprite) {
    sprites.destroy(otherSprite, effects.confetti, 100)
    scene.cameraShake(4, 100)
    otherSprite.setFlag(SpriteFlag.Ghost, true)
})
...
let 敵人子彈_3 = 0
let 敵人子彈_1 = 0
let hero_下_飛彈: Sprite = null
let hero_上_飛彈: Sprite = null
let hero_右_飛彈: Sprite = null
let hero_左_飛彈: Sprite = null
let 方向變數 = 0
...
scene.setBackgroundImage(img`
    ...
    `)
game.showLongText("這個世界突然出現了許多的怪物，牠們正在破壞這個城市，我們必須要把怪物消滅才能保護這座城市，請務必小心自身安全，加油。", DialogLayout.Bottom)
pause(500)
info.setLife(3)
info.setScore(0)
...
herostartpoint()
關卡敵人初始化()
music.play(music.stringPlayable("C5 A B G A F G E ", 150), music.PlaybackMode.LoopingInBackground)
let house = sprites.create(img`
    ...
    `, SpriteKind.house)
tiles.placeOnTile(house, tiles.getTileLocation(1, 13))
game.onUpdateInterval(randint(3000, 10000), function () {
    if (value_6 == 1) {
        pause(500)
        從敵人射出的飛彈_敵人5()
    } else if (value_7 == 1) {
...
game.onUpdateInterval(100, function () {
    if (敵人子彈_1 >= 5) {
        sprites.destroy(敵人1, effects.spray, 500)
        敵人子彈_1 = 0
        value_5 = 0
    }
    if (敵人子彈_2 >= 5) {
        sprites.destroy(敵人2, effects.spray, 500)
        敵人子彈_2 = 0
        value_6 = 0
    }
    if (敵人子彈_3 >= 5) {
        sprites.destroy(敵人3, effects.spray, 500)
        敵人子彈_3 = 0
        value_7 = 0
    }
})
